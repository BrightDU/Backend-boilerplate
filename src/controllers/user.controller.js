  ...
  addAddress: async (req, res) => {
    try {
      ...
      if (!(await schema.isValid(body.address)))
        ...
        //Use the user id to find the user in the User Table
      ...
      //If address does not exists, create a new Address in the Address Table
      if (!address) {
        address = await Address.create(body.address);
      }

      //in the UserAddress Table, create a new address entry(using the recursive algorithm) for the given User
